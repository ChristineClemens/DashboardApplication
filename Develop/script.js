...
function displayData(data) {
    console.log(data);
    document.querySelector(".navbarInfo").innerHTML = `<img src='http://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png'> ${data.name} <br> ${data.main.temp} <br> ${localTime}`;
}
